...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog='cat4cnv',
                                     formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                     description="Concatenation of N CNV files in one file (all.cnv). CNV files could\
    ...
    outfh = open('%s/all.cnv' % args.outdir, 'w')
    header = False
