...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog='cat4loh',
                                     formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                     description="Concatenation of N LOH files in one file (all.loh). LOH files could\
    ...
    parser.add_argument("-t", "--type",
                        ...
                        choices=['p', 'q'],
                        required=True,
                        help="LOH result obtain from PennCNV (-t p) or QuantiSNP (-t q) programs")
